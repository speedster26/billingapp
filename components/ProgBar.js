    ...
    return (
        <div className='w-fit mx-auto mt-12 p-4 shadow-lg bg-white rounded-3xl hover:scale-105 transition hover:cursor-pointer hidden md:block'>
            <div className='flex w-full'>
                {p.indexOf(page) <= 0 && <div className='flex flex-col items-center justify-center'><div className='h-16 w-16 rounded-full border border-slate-300 flex items-center justify-center text-sm'><AiOutlineShoppingCart className='w-8 h-8'/></div><div>{p[0]}</div></div>}
                ...
                {p.indexOf(page) <= 1 && <div className='flex flex-col items-center justify-center'><div className='h-16 w-16 rounded-full border border-slate-300 flex items-center justify-center text-sm'><GiNotebook className='w-8 h-8'/></div><div>{p[1]}</div></div>}
                ...
                {p.indexOf(page) <= 2 && <div className='flex flex-col items-center justify-center'><div className='h-16 w-16 rounded-full border border-slate-300 flex items-center justify-center text-sm'><TbCheckupList className='w-8 h-8'/></div><div>{p[2]}</div></div>}
